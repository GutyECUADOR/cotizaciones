  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <li>Debe tener una sola columna "NUEVONOMBRE" en mayusculas el mismo que indica el nuevo nombre del producto.</li>
        
        </ol>

        <a class="btn btn-success btn-block" href="<?php echo PLANTILLA_ACTUALIZAR_NOMBRES_PRODUCTOS; ?>" role="button">
