        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button @click="generarGuia" type="button" class="btn btn-success" :disabled="generando_guia.isloading"  >
                        <i class="fa" :class="[{'fa-spin fa-refresh': generando_guia.isloading}, {  'fa-file' : !generando_guia.isloading  }]" ></i> Generar Guia
                    </button>
