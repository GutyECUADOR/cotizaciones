  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <img src="<?php echo AYUDA_ACTUALIZAR_PRECIOS_PRODUCTOS?>" class="img-fluid">
        <a class="btn btn-success btn-block" href="<?php echo PLANTILLA_ACTUALIZAR_PRECIOS_PRODUCTOS; ?>" role="button">
