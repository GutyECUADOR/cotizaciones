    ...
    methods:{
        ...
        addToListProductos(){
            ...
            if (existeInArray === -1 && this.nuevoProducto.codigo.length > 0) {
                ...
                swal({
                    title: "Ops!",
                    text: `El item ${this.nuevoProducto.codigo} ya existe en la lista de productos a facturar o no es un producto válido.`,
                    type: "warning",
        ...
        showModalEnvio(){
            if (this.documento.productos.length >= 1) {
